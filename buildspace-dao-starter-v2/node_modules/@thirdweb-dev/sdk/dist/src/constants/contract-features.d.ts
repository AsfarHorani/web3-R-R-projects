import { FEATURE_NFT, FEATURE_NFT_BATCH_MINTABLE, FEATURE_NFT_ENUMERABLE, FEATURE_NFT_MINTABLE, FEATURE_NFT_SUPPLY } from "@thirdweb-dev/sdk/dist/src/constants/erc721-features";
import { FEATURE_TOKEN, FEATURE_TOKEN_BATCH_MINTABLE, FEATURE_TOKEN_MINTABLE } from "@thirdweb-dev/sdk/dist/src/constants/erc20-features";
import { FEATURE_EDITION, FEATURE_EDITION_BATCH_MINTABLE, FEATURE_EDITION_ENUMERABLE, FEATURE_EDITION_MINTABLE } from "@thirdweb-dev/sdk/dist/src/constants/erc1155-features";
import { FEATURE_PERMISSIONS, FEATURE_PLATFORM_FEE, FEATURE_PRIMARY_SALE, FEATURE_ROYALTY } from "@thirdweb-dev/sdk/dist/src/constants/thirdweb-features";
/**
 * @internal
 */
